...
// 용도 : 유키
// 설명 : 고유 스킬 및 패턴을 관리
//class YSJ_Char : public GameEngineActor
//{
//private:
//
//public:
...
//	void Action_Idle_Update(float _DeltaTime);
//	void Action_Idle_End() ;
//
//	void Action_Walk_Start() ;
//	void Action_Walk_Update(float _DeltaTime) ;
//	void Action_Walk_End() ;
//
//	//void Run_Start() override;
//	//void Run_Update(float _DeltaTime) override;
//	//void Run_End() override;
//
//	void Action_Attack_Start() ;

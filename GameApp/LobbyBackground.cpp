...
{
	{
		BackGroundRenderer = CreateTransformComponent<GameEngineUIRenderer>(GetTransform(), static_cast<int>(RenderOrder::BACKDROP));
	...
	{
		Deco_GlowingRenderer = CreateTransformComponent<GameEngineUIRenderer>(GetTransform(), static_cast<int>(RenderOrder::BACKDROP));
	...
	{
		Deco_CircleRenderer = CreateTransformComponent<GameEngineUIRenderer>(GetTransform(), static_cast<int>(RenderOrder::BACKDROP));
	...
	{
		Deco_CharSelectBgRenderer = CreateTransformComponent<GameEngineUIRenderer>(GetTransform(), static_cast<int>(RenderOrder::BACKDROP));
